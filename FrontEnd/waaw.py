...
from . import structure_beta as R
...
for i in range(len(obj.symbol)):
    ...
    if obj.symbol[i].base.wild:
        print("\t\t\tbase_wild_multiplier : ", obj.symbol[i].base.wild.multiplier, '\t\t|\t\t', joj.base.symbol[i].wild.multiplier)
        print("\t\t\tbase_wild_expand : ", obj.symbol[i].base.wild.expand, '\t\t|\t\t', joj.base.symbol[i].wild.expand)
        print("\t\t\tbase_wild_substitute : ", obj.symbol[i].base.wild.substitute, '\t\t|\t\t', joj.base.symbol[i].wild.substitute)
    else:
        print("\t\tbase_wild : ", obj.symbol[i].base.wild, '\t\t|\t\t', joj.base.symbol[i].wild)
    print("\t\tbase_substituted_by : ", obj.symbol[i].base.substituted_by, '\t\t|\t\t', joj.base.symbol[i].substituted_by)
    print("\t\tbase_substituted_by_e : ", obj.symbol[i].base.substituted_by_e, '\t\t|\t\t', joj.base.symbol[i].substituted_by_e)
    print("\tfree")
    ...
    if obj.symbol[i].free.wild:
        print("\t\t\tfree_wild_multiplier : ", obj.symbol[i].free.wild.multiplier, '\t\t|\t\t', joj.free.symbol[i].wild.multiplier)
        print("\t\t\tfree_wild_expand : ", obj.symbol[i].free.wild.expand, '\t\t|\t\t', joj.free.symbol[i].wild.expand)
        print("\t\t\tfree_wild_substitute : ", obj.symbol[i].free.wild.substitute, '\t\t|\t\t', joj.free.symbol[i].wild.substitute)
    else:
        print("\t\tfree_wild : ", obj.symbol[i].free.wild, '\t\t|\t\t', joj.free.symbol[i].wild)
    print("\t\tfree_substituted_by : ", obj.symbol[i].free.substituted_by, '\t\t|\t\t', joj.free.symbol[i].substituted_by)
    print("\t\tfree_substituted_by_e : ", obj.symbol[i].free.substituted_by_e, '\t\t|\t\t', joj.free.symbol[i].substituted_by_e)
    print("____________________________________________________________________________________________________")
...
if "base" in interim["symbol"][0]:
    print(interim["symbol"][0]["base"].get("position"))
